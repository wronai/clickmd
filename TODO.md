...
- [ ] src/clickmd/devtools.py:33 - Relative import (level=1): '.renderer'
- [ ] src/clickmd/devtools.py:266 - String concatenation can be converted to f-string
- [ ] src/clickmd/devtools.py:564 - String concatenation can be converted to f-string
- [ ] src/clickmd/devtools.py:140 - String concatenation can be converted to f-string
- [ ] src/clickmd/devtools.py:24 - Unused import inspect
- [ ] src/clickmd/devtools.py:26 - Unused import os
- [ ] src/clickmd/devtools.py:31 - Unused Sequence imported from typing
- [ ] src/clickmd/devtools.py:207 - Magic number: 20 - use named constant
- [ ] src/clickmd/devtools.py:241 - Magic number: 20 - use named constant
- [ ] src/clickmd/devtools.py:55 - Magic number: 80 - use named constant
- [ ] src/clickmd/devtools.py:161 - LLM-style docstring in install_excepthook
- [ ] src/clickmd/devtools.py:203 - LLM-style docstring in debug
- [ ] src/clickmd/devtools.py:333 - LLM-style docstring in inspect_obj
...
- [ ] src/clickmd/rich_backend.py:176 - String concatenation can be converted to f-string
- [ ] src/clickmd/rich_backend.py:177 - String concatenation can be converted to f-string
- [ ] src/clickmd/rich_backend.py:276 - String concatenation can be converted to f-string
- [ ] src/clickmd/rich_backend.py:30 - Unused Theme imported from rich.theme
...
- [ ] src/clickmd/renderer.py:773 - String concatenation can be converted to f-string
- [ ] src/clickmd/renderer.py:294 - String concatenation can be converted to f-string
- [ ] src/clickmd/renderer.py:338 - String concatenation can be converted to f-string
- [ ] src/clickmd/renderer.py:12 - Unused import os
- [ ] src/clickmd/renderer.py:12 - Unused import: 'os'
- [ ] src/clickmd/renderer.py:241 - Cannot use an escape sequence (backslash) in f-strings on Python 3.10 (syntax was added in Python 3.12)
- [ ] src/clickmd/renderer.py:241 - Cannot reuse outer quote character in f-strings on Python 3.10 (syntax was added in Python 3.12)
- [ ] src/clickmd/renderer.py:67 - Magic number: 80 - use named constant
- [ ] src/clickmd/renderer.py:736 - Magic number: 76 - use named constant
- [ ] src/clickmd/renderer.py:536 - LLM-style docstring in table
- [ ] src/clickmd/renderer.py:707 - LLM-style docstring in panel
- [ ] src/clickmd/renderer.py:784 - LLM-style docstring in blockquote
- [ ] tools/md_to_html.py:183 - String concatenation can be converted to f-string
- [ ] tools/md_to_html.py:194 - String concatenation can be converted to f-string
- [ ] tools/md_to_html.py:5 - Unused import os
- [ ] tools/md_to_html.py:5 - Unused import: 'os'
- [ ] tools/md_to_html.py:247 - module execution block
- [ ] src/clickmd/themes.py:23 - Unused Optional imported from typing
- [ ] src/clickmd/themes.py:23 - Unused import: 'Optional'
...
- [ ] tools/test_examples_md.py:110 - Function 'main' missing return type (suggested: -> int)
- [ ] tools/test_examples_md.py:128 - String concatenation can be converted to f-string
- [ ] tools/test_examples_md.py:55 - String concatenation can be converted to f-string
- [ ] tools/test_examples_md.py:61 - String concatenation can be converted to f-string
- [ ] tools/test_examples_md.py:110 - standalone main function
