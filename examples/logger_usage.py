...
PROGRESS_25 = CONSTANT_25
PROGRESS_50 = CONSTANT_50
PROGRESS_75 = CONSTANT_75
...
def progress_and_steps() -> None:
    ...
    # Step by step
    log.step(1, CONSTANT_5, "Initialize project")
    log.step(2, CONSTANT_5, "Generate contract")
    log.step(CONSTANT_3, CONSTANT_5, "Generate code")
    log.step(CONSTANT_4, CONSTANT_5, "Run tests")
    log.step(CONSTANT_5, CONSTANT_5, "Deploy")
...
def llm_logging():
    ...
    # Attempt logging
    log.attempt(1, CONSTANT_3, "contract generation")
    log.attempt(2, CONSTANT_3, "contract generation")
...
def real_world_example():
    ...
    log.llm("openrouter", "nvidia/nemotron-CONSTANT_3-nano-30b-a3b:free")
